...
# def get_parameter_component_by_identifier(components: List[Component], identifier: str, identifier_type: str) -> Optional[Parameter]:
#     parameter = \
#         list(
#             filter(
#                 lambda parameter: getattr(parameter, identifier_type) == identifier,
